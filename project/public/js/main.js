(function($) {
    ...
    * App.
    ...
    var App = function() {
        this.VERSION = "1.0";
        this.AUTHOR = "CSC301";
        this.SUPPORT = "support@losingweightquick.xyz";
    ...
    * @returns {string} - Appends OSName to App.$body
    */
    App.prototype.setUserOS = function() {
        var OSName = "";
    ...
    * @returns {string} - Appends Device to App.$body
    */
    App.prototype.setUserAgent = function() {
    ...
    */
    App.prototype.isVisibleXs = function() {
    ...
    */
    App.prototype.isVisibleSm = function() {
    ...
    */
    App.prototype.isVisibleMd = function() {
    ...
    */
    App.prototype.isVisibleLg = function() {
    ...
    */
    App.prototype.getUserAgent = function() {
    ...
    */
    App.prototype.setFullScreen = function(element) {
    ...
    * @returns {rgba}
    */
    App.prototype.getColor = function(color, opacity) {
    ...
    */
    App.prototype.initSidebar = function(context) {
    ...
    */
    App.prototype.initDropDown = function(context) {
    ...
    * @description Initialize form group input
    * @param {(Element|JQuery)} [context] - A DOM Element, Document, or jQuery to use as context.
    */
    App.prototype.initFormGroupDefault = function(context) {
    ...
    * @requires bootstrap.js
    */
    App.prototype.initSlidingTabs = function(context) {
    ...
    */
    App.prototype.reponsiveTabs = function() {
        //Dropdown FX
    ...
    * @description Initialize Header Notifcation Dropdown
    */
    App.prototype.initNotificationCenter = function() {
    ...
    * @description Initialize ProgressBars
    */
    App.prototype.initProgressBars = function() {
    ...
    */
    App.prototype.initInputFile = function() {
    ...
    */
    App.prototype.initHorizontalMenu = function(){
    ...
    * @requires bootstrap.js
    */
    App.prototype.initTooltipPlugin = function(context) {
    ...
    * @requires select2.js
    */
    App.prototype.initSelect2Plugin = function(context) {
    ...
    */
    App.prototype.initScrollBarPlugin = function(context) {
    ...
    */
    App.prototype.initListView = function(context) {
    ...
    */
    App.prototype.initSwitcheryPlugin = function(context) {
        // Switchery - ios7 switch
        window.Switchery && $('[data-init-plugin="switchery"]', context).each(function() {
            var el = $(this);
            new Switchery(el.get(0), {
                color: (el.data("color") != null ?  $.App.getColor(el.data("color")) : $.App.getColor('success')),
    ...
    */
    App.prototype.initSelectFxPlugin = function(context) {
    ...
    * @param {(Element|JQuery)} [context] - A DOM Element, Document, or jQuery to use as context.
    */
    App.prototype.initUnveilPlugin = function(context) {
    ...
    */
    App.prototype.initValidatorPlugin = function() {
        /**
         * Open the socket.
         * @override
         */
...
(function($) {
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
         ...
         ($.App.getUserAgent() == 'desktop') && this.$sidebarMenu.scrollbar({
             ignoreOverlay: false
         });
         ...
         function sidebarMouseEnter(e) {
            var _sideBarWidthCondensed = _this.$body.hasClass("rtl") ? -_this.sideBarWidthCondensed : _this.sideBarWidthCondensed;
             ...
             if ($.App.isVisibleSm() || $.App.isVisibleXs()) {
                 return false
             }
...
(function($) {
    ...
    (typeof angular === 'undefined') && $.App.init();
})(window.jQuery);